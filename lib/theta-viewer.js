(function () {
    ...
    ThetaViewer = (function () {
        function ThetaViewer(dom) {
            ...
            this.camera = new THREE.PerspectiveCamera(72, this.width / this.height);
        ...
        ThetaViewer.prototype.setTimer = function () {
            if (this.running) {
                return;
            }
            this.running = true;
            this.timer = setInterval((function () {
                return this.displayNextMaterial();
            }).bind(this), this.interval);
        };

        ThetaViewer.prototype.clearTimer = function () {
            if (!this.running) {
                return;
            }
            this.running = false;
